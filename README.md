...
- React PWA บันทึกการขายออฟไลน์ได้เฉพาะเงินสด ส่วน PromptPay ออฟไลน์และการ Sync ออเดอร์ขึ้นเซิร์ฟเวอร์ยังไม่เปิดใช้งาน

## การอนุญาตขายออฟไลน์บน React PWA

หลัง Flask ยืนยัน session ออนไลน์สำเร็จ แอปจะบันทึกเฉพาะเครื่องหมาย trusted-device ใน IndexedDB เป็นเวลา 7 วัน (`enabledAt`, `expiresAt`, `schemaVersion`) โดยไม่เก็บ PIN, hash ของ PIN, `SECRET_KEY` หรือ session cookie เอง เมื่อหมดอายุ ต้องเชื่อมต่ออินเทอร์เน็ตและเข้าสู่ระบบสำเร็จอีกครั้งก่อนขายเงินสดออฟไลน์

หากยังมีออเดอร์ออฟไลน์ที่รอ Sync แอปจะคงอยู่ใน Local Mode แม้อินเทอร์เน็ตกลับมาแล้ว การขายเงินสดถัดไปจะบันทึกใน IndexedDB ต่อเนื่องและ PromptPay จะถูกปิดไว้ เพื่อไม่ให้สต็อกในเครื่องและเซิร์ฟเวอร์กลายเป็นสองแหล่งข้อมูลก่อนการ Sync

ข้อแลกเปลี่ยนด้านความปลอดภัยคือ ผู้ที่เข้าถึง iPad ซึ่งได้รับอนุญาตแล้วทางกายภาพสามารถใช้ POS เงินสดแบบออฟไลน์ได้จนกว่าเครื่องหมายนี้จะหมดอายุ จึงควรใช้รหัสล็อกอุปกรณ์ จำกัดผู้เข้าถึง และดูแล iPad เหมือนเครื่อง POS จริง
