...
กรอบรูปในหน้าขายเป็น **4:3 แนวนอน** ตายตัว รูปถูกย่อในเบราว์เซอร์ให้ด้านยาวไม่เกิน 800px ก่อนส่ง (`LONGEST_SIDE` ใน `frontend/src/domain/productImage.ts`) เพดานไฟล์ 400KB

**สเปกรูปที่ควรเตรียม: 1200 × 900 px (4:3) หรือใหญ่กว่าในอัตราส่วนเดียวกัน**

ระบบจะย่อให้เหลือ 800 × 600 เอง รูปที่อัตราส่วนตรง 4:3 จะเต็มกรอบพอดี ไม่มีแถบข้างและไม่มีส่วนไหนถูกตัด

ถ้ารูปไม่ใช่ 4:3 จะไม่ถูกครอป แต่จะมีแถบสีพื้นของการ์ดคั่นด้านที่เหลือ — เลือกแบบนี้เพราะการครอปรูปเค้กทรงสูงจะเหลือแค่ท่อนกลาง ซึ่งไม่ใช่สิ่งที่พนักงานกวาดตาหา

ขนาดกรอบจริงที่วัดได้ (css px):

| จอ | กรอบรูป |
|---|---|
| เดสก์ท็อป 1440 | 203 × 152 |
| เดสก์ท็อป 1280 | 237 × 178 |
| แท็บเล็ตแนวนอน 1180 | 327 × 245 |
| แท็บเล็ตแนวตั้ง 820 | 147 × 110 |
| มือถือ 390 | 175 × 131 |
